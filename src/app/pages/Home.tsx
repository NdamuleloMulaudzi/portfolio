    ...
    <div className="home-container   text-white flex flex-col">
      ...
      <div className="socials z-20">
        <div className="social">
          ...
          />
          <a
            href="https://twitter.com/ndamulelomulaudzi"
            target="_blank"
        ...
        <div className="social">
          ...
          />
          <a
            href="https://github.com/NdamuleloMulaudzi"
            target="_blank"
            rel="noopener noreferrer"
          >
            <Image
        ...
        <div className="social">
          ...
          />
          <a
            href="https://www.linkedin.com/in/ndamumulaudzi/"
            target="_blank"
            rel="noopener noreferrer"
          >
            <Image
      ...
      <div className="home-text relative">
        ...
        <div className="mb-19 animate-slideIn z-10">
          <p
            id="name"
            className=" text-[70px] font-['dw'] font-semibold tracking-[2px] capitalize text-white text-shadow-md"
          >
            Ndamulelo Mulaudzi
          </p>
        ...
        <div className="sub-heading z-10">
          <p>
            I create innovative, scalable, and user-friendly web applications.
            With a passion for clean code and solving real-world problems, I’m
            always looking to learn and grow in the tech space.
          </p>
        </div>
      </div>
